...
USER_BOT_NO_WARN = ("`Hey There!`\n"
                    ...
                    f"`I Have Not Approved You To PM.`\n"
                    "`Try Tagging Me In A Group Instead!`\n"
                    "`Or You Can Wait Until I Respond!`")
    ...
    async def approve_p_m(event):
        ...
        if event.is_private:
            if pmpermit_sql.is_approved(chat.id):
                ...
                await event.edit("You've Been Blocked Because I Think You're spamming.\nHave Fun [{}](tg://user?id={})".format(firstname, chat.id))
                await asyncio.sleep(3)
